set :application, "TravelPic"             # APPL-NAME  をアプリのプロジェクト名に設定
set :repository,  "git@git.drecom.jp:rookies/travelpic.git"    # GIT-REPOSITORY-URLに Gitサーバー上のリポジトリのURLを設定
set :server_ip, "192.168.141.164"                  # SERVER-IPにサーバーのIP アドレスを設定
